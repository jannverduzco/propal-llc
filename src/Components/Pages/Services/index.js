  ...
  return (
    <div className="container">
      ...
      <Card
        ...
        list1="We provide tax preparation services for business and individuals. A
      few common forms we prepare include:"
        sublist1="1040 - Individual Income Tax Return"
        sublist2="1040NR - Non-Resident Individual Income Tax Return"
        sublist3="1120 - Corporate Income Tax Return"
        sublist4="1120S - Subchapter S Corporate Income Tax Return"
        sublist5="1065 - Partnership Income Tax Return"
        sublist6="7002 - Application for Individual Taxpayer Identification Number
      (ITIN)"
        list2="State returns, if needed"
        list3="Foreign reporting of income, assets, and other disclosures"
        list4="IRS Audits"
        list5="IRS or State Notices"
      >
        <ul>
          <li>
            We provide tax preparation services for business and individuals. A
            few common forms we prepare include:
          </li>
          <ul>
            ...
            <li>
              7002 - Application for Individual Taxpayer Identification Number
              (ITIN)
            </li>
          </ul>
          <li>State returns, if needed</li>
          <li>Foreign reporting of income, assets, and other disclosures</li>
          <li>IRS Audits</li>
